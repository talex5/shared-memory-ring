...
(* OASIS_START *)
(* DO NOT EDIT (digest: 51f34c22456a5a7ab89384b301017eaa) *)
(*
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$ring_test", []))];
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["barrier_stubs.c"; "barrier.h"];
                      bs_data_files = [];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "shared-memory-ring";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "console_ring";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "shared_memory_ring"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Console_ring"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "shared_memory_ring";
                      lib_findlib_name = Some "console";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "xenstore_ring";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                     cs_name = "lwt_shared_memory_ring";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "shared_memory_ring";
                           InternalLibrary "xenstore_ring";
                           InternalLibrary "console_ring";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lwt.unix", None);
                           InternalLibrary "shared_memory_ring";
                           InternalLibrary "lwt_shared_memory_ring";
                           FindlibPackage ("oUnit", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "client.ml"});
               Test
                 ({
                     cs_name = "ring_test";
                     cs_data = PropList.Data.create ();
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "lwt_test";
                      test_run =
                        [
                           (OASISExpr.ENot (OASISExpr.EFlag "tests"), false);
                           (OASISExpr.EFlag "tests", false);
